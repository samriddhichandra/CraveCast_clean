...
// mocks storage upload
jest.mock('../../../src/lib/storage', () => ({
    getImagePublicUrl: (location: string) => `https://example.supabase.co/storage/v1/object/public/public-bucket/images/${location}.png`,
    uploadImagesToStorage: jest.fn(() => Promise.resolve([
        {
